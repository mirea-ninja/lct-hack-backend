...
class Adjustment(Base):
    ...
    price_trade = Column(Numeric, nullable=False)
    floor = Column(Float, nullable=False)
    price_floor = Column(Numeric, nullable=False)
    apt_area = Column(Float, nullable=False)
    price_area = Column(Numeric, nullable=False)
    kitchen_area = Column(Float, nullable=False)
    price_kitchen = Column(Numeric, nullable=False)
    has_balcony = Column(Float, nullable=False)
    price_balcony = Column(Numeric, nullable=False)
    distance_to_metro = Column(Float, nullable=False)
    price_metro = Column(Numeric, nullable=False)
    quality = Column(Float, nullable=False)
    price_final = Column(Numeric, nullable=False)
