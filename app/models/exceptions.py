...
endpoint_message = {
    ...
    ("GET", "/user/email/{email}"): "Ошибка получения пользователя по email",
    ...
    ("POST", "/pull"): "Ошибка загрузки пула",
    ("PATCH", "/query/{id}/set/base"): "Ошибка установки эталонного объекта",
    ("GET", "/query/{id}/analogs"): "Ошибка получения аналогов",
    ("PATCH", "/query/{id}/set/analogs"): "Ошибка установки аналогов",
    ("GET", "/archive"): "Ошибка получения записей из архива",
    ("GET", "/archive/{id}"): "Ошибка получения записи из архива по id",
    ("DELETE", "/archive/{id}"): "Ошибка удаления записи из архива по id",
}
